<template>
    <div class="my-6">
        ...
        <div class="flex items-center">   
            ...
            <button type="button" @click="getWeather" class="p-2.5 ml-2 text-sm font-medium text-white bg-primary radius-lg border border-primary hover:brightness-95 focus:ring-2 focus:outline-none focus:ring-primary">
...
<script setup>
    ...
    const   getWeather =  async () => {
      ...
      const param1 = 'London'
      await store.fetchWeather(param1)
    }
