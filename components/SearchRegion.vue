    ...
    <div class="my-6">
        <div class="bg-white rounded-medium shadow-shallow px-4 py-6"> 
            <div class="relative">
                ...
                <div 
                    v-if="searchValue"
                    class="max-h-400px w-[calc(100%_-_3rem)] bg-white rounded-medium shadow-shallow mt-2 p-4 absolute top-14 left-0 z-10"
                >
                    <p 
                        class="py-3 text-secondary text-sm font-medium cursor-pointer border-b border-gray100 last:border-b-0"
