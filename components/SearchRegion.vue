            ...
            <div class="relative">
                <div class="flex items-center">   
                    <div class="relative w-full">
                        ...
                        <input type="text" v-model="searchValue" @input="onchangeHandle" class="bg-gray dark:bg-dark border border-primary text-secondary dark:text-textLight text-sm font-normal radius-lg focus:ring-primary focus:border-primary block w-full pl-10 p-2.5" placeholder="Search City" required>
                    </div>
                ...
                <div 
                    v-if="searchValue"
                    class="max-h-400px w-[calc(100%_-_3rem)] bg-white dark:bg-dark rounded-medium shadow-shallow mt-2 p-4 absolute top-14 left-0 z-10"
                >
                    <p 
